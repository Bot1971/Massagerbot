...
module.exports.run = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("Yesবস যাকে ক্সুদ্দে চাউ তাকে @ম্যানশন দেও ", event.threadID);
...
setTimeout(() => {a({body: "Hi আমার এর জারজ মাগির মেয়ে  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "Hi rose এর জারজ মেয়ে মাগির মেয়ে  💔!" + " " + name, mentions: arraytag})}, 9000);
